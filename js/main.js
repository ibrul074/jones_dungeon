...
function avancerIntro() {
    if (introImage.src.endsWith('/assets/introGame1.png')) { // first page
        introImage.src = '/assets/introGame2.png'; // show second page
    }
    
    else if (introImage.src.endsWith('/assets/introGame2.png')) // if second page we hide it
    {
        introImage.src = ''; 
...
document.addEventListener('keydown', (event) => {
    ...
    if (direction) {
        newPositionHero = moveCharacter(direction, 'hero', heroVertical, heroHorizontal); // move the hero
