...
export function moveCharacter(
  ...
  if (
    allyVertical === verticalPosition &&
    allyHorizontal === horizontalPosition
  ) {
    transferPoints();
  } else {
...
export function tileEffect(currentTile, character) {
  if (currentTile === 'trap') {
    ...
    if (randomNumberTrap < pourcentageWorkingBrokenTrap) {
      ...
      if (character === 'hero') {
        // effect of the trap when it doesn't works
